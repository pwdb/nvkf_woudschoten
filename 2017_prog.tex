...
\parallelheader{Radiologie en nucleaire geneeskunde}{Atrium (A7/A8)} %{{{ vrijdagmiddag
\begin{packed_enum}
...
\item[14:30] Standaarden binnen het MedMij afsprakenstelsel\itemauthor{Irene van Duijvendijk}
...
\item[14:00] Convenant 3.0: bekijk het eens vanuit de gebruiker\itemauthor{Dirk Theunissen}
\item[14:30] Procesgerichte aanpak; optimalisatie door iteratie\itemauthor{Vera Overdevest}
\item[15:00] Sluderen buiten de OK\itemauthor{Pieter Kamp}
\end{packed_enum} %}}}
...
\parallelheader{Radiologie en nucleaire geneeskunde}{Atrium (A7/A8)} %{{{ zaterdagochtend
\begin{packed_enum}
...
\item[09:30] Mammografie: Overdrachtseigenschappen bij 2D en Tomo\-synthese beelden \itemauthor{Leo Romijn}
...
\item[09:00] 4DMRI for Radiotherapy;  novel precise amplitude binning in the presence of irregular breathing\\\itemauthor{Zdenko van Kesteren}
\item[09:18] Late toxicity in the HYPRO randomized trial analyzed by automated planning and intrinsic NTCP-modelling\itemauthor{Abdul Wahab M. Sharfo}
\item[09:36] Automated treatment planning for prospective QA in the TRENDY randomized trial on liver-SBRT for HCC\itemauthor{Steven Habraken}
\item[09:54] Locoregionale radiotherapie van het mammacarcinoom in NL: survey van gebruikte technieken en ontwikkelingen\itemauthor{Duncan den Boer}
\item[10:12] Automatische kwaliteitscontrole geometrische nauw\-keur\-igheid MRI voor toepassing in de radiotherapie\itemauthor{Danique Barten}
\end{packed_enum} %}}}
