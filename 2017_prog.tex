...
\begin{packed_enum}
    ...
    \item[\textbf{10:00}] \textbf{Opening}\itemauthor{Lieke Poot, voorzitter NVKF}
        \vfill
    \item[10:05] Gezondheidszorg en Technologie: een onderwijskundig perspectief \itemauthor{Heleen Miedema, Technische Geneeskunde, Universiteit Twente}
        \vfill
...
\item[14:00] Aanschafproces in Radboud UMC\itemauthor{Erik Gelderblom}
\item[14:22] Stroomschema medische hulpmiddelen in het MMC\itemauthor{Carola van Pul en/of Eduard Meijer}
\item[14:44] ECRI Top 10\itemauthor{Mark den Blanken}
\item[15:08] Bekwaam in het OLVG\itemauthor{Job Gutteling}
\end{packed_enum} %}}}
...
\begin{packed_enum}
\item[\textbf{09:00}] \textbf{BVT Sessie (2)}
...
\item[\#5] Improved class solutions for prostate brachytherapy planning via evolutionary machine learning\itemauthor{Stef Maree}
...
\item[\#8] Impact of model and dose uncertainty on NTCP-model-based patient selection for proton therapy\itemauthor{Sebastiaan Breedveld}
...
\item[\#11] Does intrafraction motion between breath holds during breast cancer treatment impact on delivered dose?\itemauthor{Martijn Kusters}
