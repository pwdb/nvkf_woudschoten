...
%\noindent{{\color{Blue}{\textbf{\textit{{#1}}}}}\hfill{\textit{{#2}}}}\vspace{-0.1cm}
}
...
\plenairheader{Plenair Programma}{Vrijdag 27 maart 2015}
...
\begin{packed_enum}
    ...
    \item[{\color{Blue}{\textbf{11:20}}}] {\color{Blue}{\textbf{Bijeenkomsten van de kringen (1)}}}
        \vfill
    %\item[12:45] Lunch 
    %\item[12:45] Bijeenkomst klinisch fysici in opleiding
    %\item[12:45] Bijeenkomst Nederlandse Vereniging voor Klinische Informatica in oprichting
    \item[12:45] Lunch\\
    ...
    %\item[16:30] JOP 1\\\textit{supergeheim 1}
    %\item[16:50] JOP 2\\\textit{supergeheim 2}
    %\item[17:10] JOP 3\\\textit{supergeheim 3}
        \vfill
...
\plenairheader{Plenair Programma}{Zaterdag 28 maart 2015}
...
\hrule \vspace{3mm}
\vfill
\parallelitem{Parallelsessies (1) vrijdagochtend 27 maart}\\

\parallelheader{Klinische Audiologie}{Zaal 24}
\begin{packed_enum}
...
\parallelitem{Parallelsessies (2) vrijdagmiddag 27 maart}\\
...
%\columnbreak
\parallelitem{Parallelsessies (3) zaterdagochtend 28 maart}\\
\vfill
\parallelheader{Klinische Audiologie}{Kapelzaal}
\begin{packed_enum}
...
\parallelheader{Klinische Radiotherapie \& Beeldvormende Technieken}{Plenair}
\begin{packed_enum}
...
\end{packed_enum}
%\item[] \textit{De sessie staat in het teken van huidige en met name toekomstige normen en waarden ten aanzien van de praktijkvoering van Algemene Klinische Fysica.}
%\textit{De sessie staat in het teken van huidige en met name toekomstige normen en waarden ten aanzien van de praktijkvoering van Algemene Klinische Fysica.}
