...
\begin{packed_enum}
\item[\#1] Quantitative Tc-99m SPECT/CT: A comparison of Flash 3D, SUV SPECT and UMCS\itemauthor{Koen van Gils}
\item[\#2] Imaging performance of a digital PET scanner: a comparison to analog systems\itemauthor{Jorn van Dalen}
...
\item[\#11] In vivo dosimetry with MOSFETs and GAFCHROMIC films During IORT for Partial Breast Irradiation\itemauthor{Anna Pethoukova}
